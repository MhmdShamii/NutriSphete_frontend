        ...
        return (
            <div className="flex flex-col h-full">
                ...
                <div className="flex-1 min-h-0 overflow-y-auto no-scrollbar flex flex-col gap-3 sm:gap-4 pb-3 sm:pb-4">
                    <GlowCard speed={3.2}>
                        <div className="p-3 sm:p-4 flex items-center gap-3">
                            <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-[#FF6B35]/10 flex-shrink-0" />
                        ...
                        {[{ speed: 2.6, delay: 0 }, { speed: 2.2, delay: 0.35 }, { speed: 2.9, delay: 0.15 }, { speed: 2.4, delay: 0.5 }].map((cfg, i) => (
                            <GlowCard key={i} rounded="rounded-xl" innerRounded="rounded-[11px]" speed={cfg.speed} delay={cfg.delay}>
                                <div className="p-2.5 sm:p-3 flex items-center gap-2 sm:gap-2.5">
                                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-text-muted/10 flex-shrink-0" />
                ...
                <div className="flex-shrink-0 flex flex-col gap-2 pt-3 border-t border-border/20">
                    <button disabled className="flex items-center justify-center gap-1.5 w-full p-2 sm:p-2.5 rounded-xl border border-border/20
                        text-xs sm:text-sm text-text-muted opacity-30 pointer-events-none">
                        <EditRoundedIcon sx={{ fontSize: 15 }} /> Recalculate
                    </button>
                    <button disabled className="w-full flex items-center justify-center gap-1.5 p-2.5 sm:p-3 rounded-xl text-sm font-semibold
                        bg-primary/30 text-black/50 pointer-events-none">
                        <CheckRoundedIcon sx={{ fontSize: 16 }} /> Confirm &amp; Add to Log
                    </button>
                    <button disabled className="flex items-center justify-center gap-1 w-full py-1.5 text-[11px] sm:text-xs
            ...
            <div className="flex flex-col h-full">
                ...
                <div className="flex-shrink-0 flex flex-col gap-2 pt-3 border-t border-border/20">
                    ...
                    <button
                        ...
                        onClick={onDiscard}
                        disabled={loading}
                        className="flex items-center justify-center gap-1 w-full py-1.5 text-[11px] sm:text-xs text-red-400/60
